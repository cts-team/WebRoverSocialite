...
namespace WebRover\Socialite\Client;
...
/**
 * Class Base
 * @package WebRover\Socialite\Client
 */
abstract class Base
{
    public $http;
    ...
    /**
     * Base constructor.
     * @param string|null $appid 应用的唯一标识
     * @param string|null $appSecret appid对应的密钥
     ...
     * @param string|null $state 回调传递过来的state
     * @return bool
     */
     ...
     * @param string|null $code 第一步里$callbackUrl地址中传过来的code，为null则通过get参数获取
